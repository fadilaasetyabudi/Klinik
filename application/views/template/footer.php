 <!-- Footer -->
  ...
  <!-- Page level plugins -->
  <script src="<?php echo base_url(); ?>tema/admin/vendor/datatables/jquery.dataTables.min.js"></script>
  <script src="<?php echo base_url(); ?>tema/admin/vendor/datatables/dataTables.bootstrap4.min.js"></script>

  <!-- Page level custom scripts -->
  <script src="<?php echo base_url(); ?>tema/admin/js/demo/datatables-demo.js"></script>
