        ...
        <div class="container-fluid">
          ...
          <form class="user" action="<?php echo site_url('pasien/proses_edit/'.$this->uri->segment(3)); ?>" method="POST">   
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="exampleInputText" aria-describedby="emailHelp" placeholder="id Penjualan" name="i_id_penjualan" value="<?php echo $p_penjualan->id_penjualan; ?>">
                    </div>
                    <div class="form-group">
